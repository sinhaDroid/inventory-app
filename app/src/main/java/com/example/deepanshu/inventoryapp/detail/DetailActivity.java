package com.example.deepanshu.inventoryapp.detail;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void addValuesToEditItem(long itemId) {
        ...
        cursor.moveToFirst();
        nameEdit.setText(cursor.getString(cursor.getColumnIndex(ShopContract.ShopEntry.COLUMN_NAME)));
        priceEdit.setText(cursor.getString(cursor.getColumnIndex(ShopContract.ShopEntry.COLUMN_PRICE)));
        quantityEdit.setText(cursor.getString(cursor.getColumnIndex(ShopContract.ShopEntry.COLUMN_QUANTITY)));
        supplierNameEdit.setText(cursor.getString(cursor.getColumnIndex(ShopContract.ShopEntry.COLUMN_SUPPLIER_NAME)));
        supplierPhoneEdit.setText(cursor.getString(cursor.getColumnIndex(ShopContract.ShopEntry.COLUMN_SUPPLIER_PHONE)));
        supplierEmailEdit.setText(cursor.getString(cursor.getColumnIndex(ShopContract.ShopEntry.COLUMN_SUPPLIER_EMAIL)));
        imageView.setImageURI(Uri.parse(cursor.getString(cursor.getColumnIndex(ShopContract.ShopEntry.COLUMN_IMAGE))));
    }
    ...
    private int deleteAllRowsFromTable() {
        ...
        return database.delete(ShopContract.ShopEntry.TABLE_NAME, null, null);
    }
    ...
    private int deleteOneItemFromTable(long itemId) {
        ...
        return database.delete(ShopContract.ShopEntry.TABLE_NAME, selection, selectionArgs);
    }
